...
import 'package:yumyumnavigator/src/core/constants/assets.dart';
import 'package:yumyumnavigator/src/recipes/presentation/widget/home_screen/animated_name_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        CircleAvatar(
          radius: 18,
          backgroundColor: Color.fromARGB(153, 2, 19, 45),
