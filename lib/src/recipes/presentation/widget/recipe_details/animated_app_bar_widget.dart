...
class AnimatedAppBarWidget extends StatelessWidget {
  ...
  const AnimatedAppBarWidget({
    ...
    required this.appBarDelayTime, required Duration avatarWaitingDuration, required Duration nameDelayDuration, required Duration namePlayDuration, required Duration avatarPlayDuration,
  }) : super(key: key);
